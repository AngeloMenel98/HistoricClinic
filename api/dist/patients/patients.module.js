...
const patients_controller_1 = require("./controller/patients.controller");
const patients_service_1 = require("./service/patients.service");
...
exports.PatientsModule = PatientsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([patient_entity_1.Patient]), users_module_1.UsersModule],
        controllers: [patients_controller_1.PatientsController],
        providers: [patients_service_1.PatientsService, patient_repository_1.PatientRepository],
